        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-amber-50 p-4 rounded-xl border border-amber-100 flex gap-3">
             ...
             <div className="text-xs text-amber-800 leading-relaxed">
               <strong>Perhatian:</strong> Mengubah URL ini akan memutuskan koneksi ke database saat ini. Pastikan endpoint sudah benar.
             </div>
          </div>
          ...
          <div className="pt-4 border-t border-slate-100 flex justify-between items-center">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100 text-red-600 px-4 py-2 rounded-lg font-bold text-xs transition-all border border-red-100"
            >
              <RefreshCw size={14} /> Reset Aplikasi
            </button>
            <button
              type="submit"
              className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold text-sm transition-all shadow-lg shadow-blue-100 active:scale-95"
            >
